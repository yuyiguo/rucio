  ...
  CREATE TABLE IDENTITIES 
   (	IDENTITY VARCHAR2(2048), 
	...
	SALT BLOB, 
	 ...
	 CONSTRAINT IDENTITIES_TYPE_CHK CHECK (identity_type IN ('X509', 'GSS', 'USERPASS', 'SSH', 'SAML')), 
  ...
  CREATE TABLE ACCOUNT_MAP 
   (	IDENTITY VARCHAR2(2048), 
	...
	CREATED_AT DATE, 
	 ...
	 CONSTRAINT ACCOUNT_MAP_ID_TYPE_CHK CHECK (identity_type IN ('X509', 'GSS', 'USERPASS', 'SSH', 'SAML')) , 
...
-- 14) =============================  CONTENTS table (Index-Organised tables and List partitioned )======================
  ...
  CREATE TABLE CONTENTS 
   (	SCOPE VARCHAR2(25), 
	NAME VARCHAR2(255), // up to 500
	CHILD_SCOPE VARCHAR2(25), 
	CHILD_NAME VARCHAR2(255), // up to 500
	DID_TYPE CHAR(1), 
	CHILD_TYPE CHAR(1), 
	LENGTH NUMBER(22,0), 
	BYTES NUMBER(22,0), 
...
--PARTITION BY LIST (SCOPE) no partition by scope for CMS
--(
--    PARTITION INITIAL_PARTITION VALUES ('Initial_partition')
--)
;
