...
DROP table quarantined_replicas_history cascade constraints purge;
...
DROP table requests_history cascade constraints purge;
...
(
PARTITION "PD_DATA_BEFORE_01102013" VALUES LESS THAN (TO_DATE('01-10-2013', 'DD-MM-YYYY'))
);
...
DROP table rules_history cascade constraints purge;
...
DROP table messages_history cascade constraints purge;
...
PARTITION BY RANGE(created_at) INTERVAL ( NUMTODSINTERVAL(1,'DAY') )
(
PARTITION PD_DATA_BEFORE_01052015 VALUES LESS THAN (TO_DATE('01-05-2015', 'DD-MM-YYYY'))
)
;
...
DROP table SUBSCRIPTIONS_HISTORY cascade constraints purge;
...
DROP table rules_hist_recent cascade constraints purge;
...
PARTITION BY RANGE(updated_at) INTERVAL ( NUMTODSINTERVAL(7,'DAY') )
(
PARTITION DATA_BEFORE_01012015 VALUES LESS THAN (TO_DATE('01-01-2015', 'DD-MM-YYYY'))
);
...
DROP table sources_history cascade constraints purge;
...
PARTITION BY RANGE(CREATED_AT) INTERVAL ( NUMTODSINTERVAL(1,'DAY') )
(
PARTITION PD_DATA_BEFORE_01112015 VALUES LESS THAN (TO_DATE('01-11-2015', 'DD-MM-YYYY'))
);
...
DROP table contents_history  cascade constraints purge;
...
(
PARTITION PD_DATA_BEFORE_01012018 VALUES LESS THAN (TO_DATE('01-01-2018', 'DD-MM-YYYY'))
);
...
drop table archive_contents_history  cascade constraints purge;
...
(
   PARTITION PD_DATA_BEFORE_01012017 VALUES LESS THAN (TO_DATE('01-01-2017', 'DD-MM-YYYY'))
)
;
...
DROP table bad_replicas  cascade constraints purge;
...
DROP table replicas_history cascade constraints purge;
